...
data = readARFF("Normalized Finnish.arff")

ggplot(data=data,aes(x=rfc,y=lneff))+geom_line()+labs(title="RFC")
...
train= data[index,]
test= data[-index,]
task = TaskRegr$new("data", backend = train, target = "lneff")
